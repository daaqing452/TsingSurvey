...
class SUser(models.Model):
	...
	__var_chinese__ = ['学号', '姓名', '英文姓名', '学生类别代码', '学生类别', '性别代码', '性别', '出生日期', '名族代码', '名族', '国别代码', '国别、地区', '政治面貌代码', '政治面貌', '证件类型代码', '证件类型', '证件号', '婚姻状况代码', '婚姻状况', '原学历代码', '原学历', '大学毕校', '大学毕校码', '大学专业', '大学专业码', '大学毕业年月', '硕士毕校', '硕士毕校码', '硕士专业', '硕士专业码', '硕士毕业年月', '获硕日期', '系号', '院系所', '二级学科代码', '二级学科', '导师证号', '入学年月', '方案年月', '入学方式代码', '入学方式', '录取类别代码', '录取类别', '定向类别代码', '定向类别', '考生来源代码', '考生来源', '准考证号', '本科学号', '硕士学号', '生源地代码', '生源地', '宿舍地址', '宿舍电话', '原单位', '委定单位', '电子邮件', '是否有床位', '是否公费医疗', '是否户口迁入', '是否校内学籍', '是否国家学籍', '是否学籍异动', '是否留学生', '预计毕业日期', '答辩日期', '结业日期', '是否毕业', '结业方式代码', '结业方式', '毕业证书编号', '学位授予日期', '学位授予方式代码', '学位授予方式', '培养类别代码', '培养类别', '培养方向代码', '培养方向', '学科门类代码', '学科门类', '专业代码', '专业', '学位证书编号', '学籍状态码', '校区代码', '校区', '备注', '导师姓名', '学生特殊情况代码', '学生特殊情况', '是否一级学科', '籍贯省市代码', '籍贯省市', '籍贯市县代码', '籍贯市县', '家庭地省市代码', '家庭地省市', '委定单位地市县代码', '委定单位地市县', '原学号', '异动类别码', '异动类别', '变动日期']